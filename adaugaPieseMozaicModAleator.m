...
switch(params.criteriu)
    ...
    case 'aleator'
        %adauga piese aleatoare in mozaic, fara vre-un criteriu, pana la acoperirea tuturor pixelilor descoperiti
        ...
        while pixeliDescoperiti
            ...
            if isempty(locatiiGoale)
                ...
                % inlocuim locatiile goale cu cele care sunt eligibile
           	locatiiPixeli(locatiiGoale(locatiiCandidat)) = 1;
                ...
                for i = 1: numel(locatiiCandidat)
                    % reformez imaginea de referinta incluzand piese
            ...
            if isempty(locatiiGoale)
                ...
                for i = 1: numel(locatiiCandidat)
                    ...
                    for k = 1:size(CuloareMediePiese,1)
                        dist(k) = sqrt(sum( (CuloareMediePiese(k,:)-[fmR, fmG, fmB]).^2 )) ;
                    end
